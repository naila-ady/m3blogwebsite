...
const About = () => {
    return (
      <div className="max-w-[1920px]  container py-10 flex flex-col flex-wrap
          ...
          <p className=" font-light text-[#fFFFFF] text-[40px] py-4 ">
          ...
          <p className="font-light text-[#ffffff] text-[40px] py-4 ">Hi, I'm Naila Adnan, the creator of
          ...
          <p className="  font-light text-[#fFFFFF] text-[40px] py-4 ">I value your input and love hearing
